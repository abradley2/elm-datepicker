...
var abradley2$elm_datepicker$DatePicker$Calendar = {$: 'Calendar'};
var abradley2$elm_datepicker$DatePicker$GetToday = function (a) {
	return {$: 'GetToday', a: a};
};
var abradley2$elm_datepicker$DatePicker$None = {$: 'None'};
...
var abradley2$elm_datepicker$DatePicker$init = function (id) {
	return _Utils_Tuple2(
		{currentMonthMap: elm$core$Maybe$Nothing, id: id, indexDate: elm$core$Maybe$Nothing, monthChange: abradley2$elm_datepicker$DatePicker$None, previousMonthMap: elm$core$Maybe$Nothing, previousSelectedDate: elm$core$Maybe$Nothing, selectedDate: elm$core$Maybe$Nothing, selectionMode: abradley2$elm_datepicker$DatePicker$Calendar, today: elm$core$Maybe$Nothing, yearList: elm$core$Maybe$Nothing},
		A2(elm$core$Task$perform, abradley2$elm_datepicker$DatePicker$GetToday, justinmimbs$date$Date$today));
};
var abradley2$elm_datepicker$Demo$DatePickerMsg = function (a) {
	return {$: 'DatePickerMsg', a: a};
};
var elm$core$Platform$Cmd$map = _Platform_map;
var abradley2$elm_datepicker$Demo$init = function (flags) {
	var _n0 = abradley2$elm_datepicker$DatePicker$init('my-datepicker');
	var datePickerData = _n0.a;
	var datePickerCmd = _n0.b;
	return _Utils_Tuple2(
		{datePickerData: datePickerData, selectedDate: elm$core$Maybe$Nothing},
		A2(elm$core$Platform$Cmd$map, abradley2$elm_datepicker$Demo$DatePickerMsg, datePickerCmd));
};
var elm$core$Platform$Sub$batch = _Platform_batch;
var elm$core$Platform$Sub$none = elm$core$Platform$Sub$batch(_List_Nil);
var abradley2$elm_datepicker$Demo$subscriptions = function (model) {
	return elm$core$Platform$Sub$none;
};
var abradley2$elm_datepicker$DatePicker$Next = {$: 'Next'};
var abradley2$elm_datepicker$DatePicker$NoOp = {$: 'NoOp'};
var abradley2$elm_datepicker$DatePicker$Previous = {$: 'Previous'};
...
var abradley2$elm_datepicker$DatePicker$defaultedYearList = F2(
	function (yearList, indexDate) {
		if (yearList.$ === 'Just') {
			var list = yearList.a;
			return list;
		} else {
...
var abradley2$elm_datepicker$DatePicker$Util$buildMonthMap = F5(
	function (currentMap, currentDay, lastDay, firstDate, indexDate) {
		buildMonthMap:
		while (true) {
			var newMap = _Utils_ap(
				currentMap,
				_List_fromArray(
					[
						_Utils_Tuple2(
						...
						A3(
							justinmimbs$date$Date$fromCalendarDate,
							justinmimbs$date$Date$year(indexDate),
							justinmimbs$date$Date$month(indexDate),
							currentDay))
					]));
			if (!_Utils_eq(lastDay, currentDay)) {
				var $temp$currentMap = newMap,
					$temp$currentDay = currentDay + 1,
					$temp$lastDay = lastDay,
					$temp$firstDate = firstDate,
					$temp$indexDate = indexDate;
				currentMap = $temp$currentMap;
				currentDay = $temp$currentDay;
				lastDay = $temp$lastDay;
				firstDate = $temp$firstDate;
				indexDate = $temp$indexDate;
				continue buildMonthMap;
			} else {
				var padSize = justinmimbs$date$Date$weekdayNumber(firstDate);
				return A3(abradley2$elm_datepicker$DatePicker$Util$padMonthMap, 0, padSize, newMap);
			}
		}
	});
...
var abradley2$elm_datepicker$DatePicker$Util$getLastDayOfMonth = F2(
	function (date, prevTry) {
		getLastDayOfMonth:
		while (true) {
			var nextDate = A3(justinmimbs$date$Date$add, justinmimbs$date$Date$Days, 1, date);
			if (_Utils_cmp(
				justinmimbs$date$Date$day(nextDate),
				prevTry) > 0) {
				var $temp$date = nextDate,
					$temp$prevTry = justinmimbs$date$Date$day(nextDate);
				date = $temp$date;
				prevTry = $temp$prevTry;
				continue getLastDayOfMonth;
			} else {
				return prevTry;
			}
		}
	});
var abradley2$elm_datepicker$DatePicker$Util$setDayOfMonth = F2(
	function (date, num) {
		return A3(
			justinmimbs$date$Date$fromCalendarDate,
...
var abradley2$elm_datepicker$DatePicker$setIndexDate = F2(
	function (model, indexDate) {
		var lastDayOfMonth = A2(
			abradley2$elm_datepicker$DatePicker$Util$getLastDayOfMonth,
			indexDate,
			justinmimbs$date$Date$day(indexDate));
		var monthMap = A5(
			abradley2$elm_datepicker$DatePicker$Util$buildMonthMap,
			_List_Nil,
			1,
			lastDayOfMonth,
			A2(abradley2$elm_datepicker$DatePicker$Util$setDayOfMonth, indexDate, 1),
			indexDate);
		return _Utils_update(
			model,
			{
				currentMonthMap: elm$core$Maybe$Just(monthMap),
				indexDate: elm$core$Maybe$Just(
					A2(
...
var abradley2$elm_datepicker$DatePicker$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'NoOp':
				return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
			...
			case 'NextMonth':
				...
				var newModel = A2(abradley2$elm_datepicker$DatePicker$setIndexDate, model, newIndexDate);
				return _Utils_Tuple2(
					_Utils_update(
						newModel,
						{monthChange: abradley2$elm_datepicker$DatePicker$Next}),
					elm$core$Platform$Cmd$none);
			case 'PreviousMonth':
				var newIndexDate = msg.a;
				var newModel = A2(abradley2$elm_datepicker$DatePicker$setIndexDate, model, newIndexDate);
				return _Utils_Tuple2(
					_Utils_update(
						newModel,
						{monthChange: abradley2$elm_datepicker$DatePicker$Previous}),
					elm$core$Platform$Cmd$none);
			case 'GetToday':
				var today = msg.a;
				var updatedModel = A2(abradley2$elm_datepicker$DatePicker$setIndexDate, model, today);
				return _Utils_Tuple2(
					_Utils_update(
						updatedModel,
						{
							today: elm$core$Maybe$Just(
								A2(
									abradley2$elm_datepicker$DatePicker$Util$setDayOfMonth,
									today,
									justinmimbs$date$Date$day(today))),
							yearList: elm$core$Maybe$Just(
								A2(abradley2$elm_datepicker$DatePicker$defaultedYearList, model.yearList, today))
						}),
					elm$core$Platform$Cmd$none);
...
var abradley2$elm_datepicker$Demo$update = F2(
	function (msg, model) {
		if (msg.$ === 'NoOp') {
			return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
		} else {
			...
			return function (_n2) {
				var newModel = _n2.a;
				var cmd = _n2.b;
				if (datePickerMsg.$ === 'SubmitClicked') {
					var currentSelectedDate = datePickerMsg.a;
					return _Utils_Tuple2(
						_Utils_update(
							newModel,
							{
								selectedDate: elm$core$Maybe$Just(currentSelectedDate)
							}),
						cmd);
				} else {
...
var abradley2$elm_datepicker$DatePicker$bottomSection = F2(
	function (model, props) {
		var disableOk = _Utils_eq(model.selectedDate, elm$core$Maybe$Nothing);
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
						...
						[
							...
							_List_fromArray(
								[
									...
									_Utils_Tuple2(
									'edp-disabled',
									_Utils_eq(model.selectedDate, elm$core$Maybe$Nothing))
								])),
							elm$html$Html$Events$onClick(
							function () {
								var _n0 = model.selectedDate;
								if (_n0.$ === 'Just') {
									var date = _n0.a;
	...
	function (model, props) {
		return A2(
			...
			function (previousMonthMap) {
				return _Utils_Tuple2(
					abradley2$elm_datepicker$DatePicker$getMonthKey(model.indexDate) + '-previous',
					A2(
						elm$html$Html$div,
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										...
										_Utils_Tuple2(
										'edp-out-next',
										_Utils_eq(model.monthChange, abradley2$elm_datepicker$DatePicker$Next)),
										_Utils_Tuple2(
										'edp-out-previous',
										_Utils_eq(model.monthChange, abradley2$elm_datepicker$DatePicker$Previous))
									]))
							]),
						_List_fromArray(
							[
		...
		return A3(
			...
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					abradley2$elm_datepicker$DatePicker$getMonthKey(model.indexDate),
					A2(
						elm$html$Html$div,
						_List_fromArray(
							[
...
var abradley2$elm_datepicker$DatePicker$SetSelectionMode = function (a) {
	return {$: 'SetSelectionMode', a: a};
};
var abradley2$elm_datepicker$DatePicker$Util$getDayInfo = function (day) {
	switch (day.$) {
		case 'Sun':
			return _Utils_Tuple2('Sun', 7);
		case 'Mon':
			return _Utils_Tuple2('Mon', 1);
		case 'Tue':
			return _Utils_Tuple2('Tue', 2);
		case 'Wed':
			return _Utils_Tuple2('Wed', 3);
		case 'Thu':
			return _Utils_Tuple2('Thu', 4);
		case 'Fri':
			return _Utils_Tuple2('Fri', 5);
		default:
			return _Utils_Tuple2('Sat', 6);
	}
};
...
var abradley2$elm_datepicker$DatePicker$Util$getDayMonthText = function (date) {
	...
	var dayShort = _n1.a;
	var dayInt = _n1.b;
	return dayShort + (', ' + (A3(elm$core$String$slice, 0, 3, monthFull) + (' ' + elm$core$String$fromInt(
		justinmimbs$date$Date$day(date)))));
};
var abradley2$elm_datepicker$DatePicker$headerDayMonthDisplay = F3(
	function (isPreviousDate, date, model) {
		return A2(
			elm$core$Maybe$map,
			function (justDate) {
				return _Utils_Tuple2(
					abradley2$elm_datepicker$DatePicker$Util$getDayMonthText(justDate),
					A2(
						elm$html$Html$div,
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										...
										_Utils_Tuple2('edp-header-active', true),
										_Utils_Tuple2('edp-month-day-previous', isPreviousDate)
									])),
								elm$html$Html$Events$onClick(
								abradley2$elm_datepicker$DatePicker$SetSelectionMode(abradley2$elm_datepicker$DatePicker$Calendar))
							]),
						_List_fromArray(
							[
								elm$html$Html$text(
...
var abradley2$elm_datepicker$DatePicker$YearPicker = {$: 'YearPicker'};
					...
					_List_fromArray(
						[
							...
							_Utils_Tuple2(
								'previous',
								A2(elm$html$Html$div, _List_Nil, _List_Nil)),
							A3(abradley2$elm_datepicker$DatePicker$headerDayMonthDisplay, true, model.previousSelectedDate, model)),
							A2(
							elm$core$Maybe$withDefault,
							_Utils_Tuple2(
								'current',
							...
							A3(
								...
								false,
								abradley2$elm_datepicker$DatePicker$Util$isJust(model.selectedDate) ? model.selectedDate : elm$core$Maybe$Just(model.today),
								model))
						]))
				]));
	});
var abradley2$elm_datepicker$DatePicker$NextMonth = function (a) {
	return {$: 'NextMonth', a: a};
};
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Events$onClick(
							canSelectPrevious ? abradley2$elm_datepicker$DatePicker$PreviousMonth(
								A3(justinmimbs$date$Date$add, justinmimbs$date$Date$Months, -1, model.indexDate)) : abradley2$elm_datepicker$DatePicker$NoOp)
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											_Utils_Tuple2('material-icons arrow-icon', true),
						...
						[
							...
							function () {
								...
								return monthFull + (' ' + elm$core$String$fromInt(
									justinmimbs$date$Date$year(model.indexDate)));
							}())
						])),
					A2(
					elm$html$Html$div,
					_List_fromArray(
						[
							elm$html$Html$Events$onClick(
							canSelectNext ? abradley2$elm_datepicker$DatePicker$NextMonth(
								A3(justinmimbs$date$Date$add, justinmimbs$date$Date$Months, 1, model.indexDate)) : abradley2$elm_datepicker$DatePicker$NoOp)
						]),
					_List_fromArray(
						[
...
var abradley2$elm_datepicker$DatePicker$yearSection = function (model) {
	...
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$id('edp-year-picker-' + model.id),
				...
				F3(
					function (today, indexDate, currentMonthMap) {
						...
						var mainSection = function () {
							var _n0 = initializedModel.selectionMode;
							if (_n0.$ === 'Calendar') {
								return A2(
									elm$html$Html$div,
									_List_Nil,
								...
								return A2(
									...
									_List_fromArray(
										[
											abradley2$elm_datepicker$DatePicker$yearSection(initializedModel),
											footer
										]));
							}
						}();
						var displayDate = A2(elm$core$Maybe$withDefault, today, model.selectedDate);
						return A2(
							elm$html$Html$div,
							_List_fromArray(
								[
			...
			[
				...
				_List_fromArray(
					[
						...
						A2(abradley2$elm_datepicker$DatePicker$view, model.datePickerData, abradley2$elm_datepicker$DatePicker$defaultProps))
					]))
			]));
};
var elm$browser$Browser$element = _Browser_element;
var abradley2$elm_datepicker$Demo$main = elm$browser$Browser$element(
	{init: abradley2$elm_datepicker$Demo$init, subscriptions: abradley2$elm_datepicker$Demo$subscriptions, update: abradley2$elm_datepicker$Demo$update, view: abradley2$elm_datepicker$Demo$view});
_Platform_export({'Demo':{'init':abradley2$elm_datepicker$Demo$main(
	elm$json$Json$Decode$succeed(
		{}))({"versions":{"elm":"0.19.0"},"types":{"message":"Demo.Msg","aliases":{"Date.RataDie":{"args":[],"type":"Basics.Int"}},"unions":{"Demo.Msg":{"args":[],"tags":{"NoOp":[],"DatePickerMsg":["DatePicker.Msg"]}},"DatePicker.Msg":{"args":[],"tags":{"NoOp":[],"DateSelected":["Date.Date","Date.Date"],"GetToday":["Date.Date"],"PreviousMonth":["Date.Date"],"NextMonth":["Date.Date"],"SubmitClicked":["Date.Date"],"CancelClicked":[],"SetSelectionMode":["DatePicker.SelectionMode"]}},"DatePicker.SelectionMode":{"args":[],"tags":{"Calendar":[],"YearPicker":[]}},"Date.Date":{"args":[],"tags":{"RD":["Date.RataDie"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}}}}})}});}(this));