...
var _abradley2$elm_datepicker$DatePicker_Util$setDayOfMonth = F2(
	function (date, num) {
		return A7(
...
var _abradley2$elm_datepicker$DatePicker_Util$padMonthMap = F3(
	function (currentIndex, stopIndex, monthMap) {
		padMonthMap:
		while (true) {
			if (_elm_lang$core$Native_Utils.eq(currentIndex, stopIndex)) {
				return monthMap;
			} else {
				var _v0 = currentIndex + 1,
					_v1 = stopIndex,
					_v2 = {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 0,
						_1: _elm_lang$core$Date$fromTime(0)
					},
					_1: monthMap
				};
				currentIndex = _v0;
...
var _abradley2$elm_datepicker$DatePicker_Util$getLastDayOfMonth = F2(
	function (date, prevTry) {
		getLastDayOfMonth:
		while (true) {
			var nextDate = A3(_rluiten$elm_date_extra$Date_Extra_Duration$add, _rluiten$elm_date_extra$Date_Extra_Duration$Day, 1, date);
			if (_elm_lang$core$Native_Utils.cmp(
				_elm_lang$core$Date$day(nextDate),
				prevTry) > 0) {
				var _v3 = nextDate,
					_v4 = _elm_lang$core$Date$day(nextDate);
				date = _v3;
				prevTry = _v4;
...
var _abradley2$elm_datepicker$DatePicker_Util$getMonthInfo = function (month) {
	...
	switch (_p0.ctor) {
		case 'Jan':
			return {ctor: '_Tuple2', _0: 'January', _1: 1};
		case 'Feb':
			return {ctor: '_Tuple2', _0: 'Febuary', _1: 2};
		case 'Mar':
			return {ctor: '_Tuple2', _0: 'March', _1: 3};
		case 'Apr':
			return {ctor: '_Tuple2', _0: 'April', _1: 4};
		case 'May':
			return {ctor: '_Tuple2', _0: 'May', _1: 5};
		case 'Jun':
			return {ctor: '_Tuple2', _0: 'June', _1: 6};
		case 'Jul':
			return {ctor: '_Tuple2', _0: 'July', _1: 7};
		case 'Aug':
			return {ctor: '_Tuple2', _0: 'August', _1: 8};
		case 'Sep':
			return {ctor: '_Tuple2', _0: 'September', _1: 9};
		case 'Oct':
			return {ctor: '_Tuple2', _0: 'October', _1: 10};
		case 'Nov':
			return {ctor: '_Tuple2', _0: 'November', _1: 11};
		default:
...
var _abradley2$elm_datepicker$DatePicker_Util$getDayInfo = function (day) {
	...
	switch (_p3.ctor) {
		...
		case 'Mon':
			return {ctor: '_Tuple2', _0: 'Mon', _1: 2};
		case 'Tue':
			return {ctor: '_Tuple2', _0: 'Tue', _1: 3};
		case 'Wed':
			return {ctor: '_Tuple2', _0: 'Wed', _1: 4};
		case 'Thu':
			return {ctor: '_Tuple2', _0: 'Thu', _1: 5};
		case 'Fri':
			return {ctor: '_Tuple2', _0: 'Fri', _1: 6};
		default:
...
var _abradley2$elm_datepicker$DatePicker_Util$getDayNum = function (date) {
	return _elm_lang$core$Tuple$second(
		_abradley2$elm_datepicker$DatePicker_Util$getDayInfo(
...
var _abradley2$elm_datepicker$DatePicker_Util$buildMonthMap = F5(
	function (currentMap, currentDay, lastDay, firstDate, indexDate) {
		...
		while (true) {
			var newMap = A2(
				...
				currentMap,
				{
					...
					_0: {
						...
						_1: A7(
							_rluiten$elm_date_extra$Date_Extra_Create$dateFromFields,
							_elm_lang$core$Date$year(indexDate),
							_elm_lang$core$Date$month(indexDate),
							currentDay,
							0,
							0,
							0,
			...
			if (!_elm_lang$core$Native_Utils.eq(lastDay, currentDay)) {
				var _v7 = newMap,
					_v8 = currentDay + 1,
					_v9 = lastDay,
					_v10 = firstDate,
...
var _abradley2$elm_datepicker$DatePicker_Util$getDayMonthText = function (date) {
	var _p4 = _abradley2$elm_datepicker$DatePicker_Util$getDayInfo(
		_elm_lang$core$Date$dayOfWeek(date));
	var dayShort = _p4._0;
	var dayInt = _p4._1;
	var _p5 = _abradley2$elm_datepicker$DatePicker_Util$getMonthInfo(
		_elm_lang$core$Date$month(date));
	var monthFull = _p5._0;
	var monthInt = _p5._1;
	return A2(
		_elm_lang$core$Basics_ops['++'],
		dayShort,
...
var _abradley2$elm_datepicker$DatePicker$weekSection = F2(
	function (model, props) {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('edp-body-section'),
				_1: {ctor: '[]'}
			},
			A2(
				_elm_lang$core$List$map,
				function (symbol) {
					return A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('edp-column edp-day-symbol'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _abradley2$elm_datepicker$DatePicker$defaultProps = {
...
var _abradley2$elm_datepicker$DatePicker$setIndexDate = F2(
	function (model, indexDate) {
		...
		var monthMap = A5(
			...
			1,
			lastDayOfMonth,
			A2(_abradley2$elm_datepicker$DatePicker_Util$setDayOfMonth, indexDate, 1),
			indexDate);
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				indexDate: _elm_lang$core$Maybe$Just(
					A2(
						_abradley2$elm_datepicker$DatePicker_Util$setDayOfMonth,
						indexDate,
						_elm_lang$core$Date$day(indexDate))),
...
var _abradley2$elm_datepicker$DatePicker$Model = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
...
var _abradley2$elm_datepicker$DatePicker$Props = F4(
	function (a, b, c, d) {
		...
		var _p0 = function () {
			...
			if (_p1.ctor === 'Just') {
				...
				return {
					...
					_1: _abradley2$elm_datepicker$DatePicker_Util$getDayMonthText(_p2)
				};
			} else {
				return {
					ctor: '_Tuple2',
					...
					_1: _abradley2$elm_datepicker$DatePicker_Util$getDayMonthText(model.today)
				};
			}
		}();
		var yearText = _p0._0;
		var dayMonthText = _p0._1;
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				...
				_1: {
					...
					_0: A3(
						...
						A2(
							...
							function () {
								var _p3 = model.previousSelectedDate;
								if (_p3.ctor === 'Just') {
									var _p4 = _p3._0;
									return {
										ctor: '::',
										_0: {
											ctor: '_Tuple2',
											_0: _abradley2$elm_datepicker$DatePicker_Util$getDayMonthText(_p4),
											_1: A2(
												_elm_lang$html$Html$div,
												{
													ctor: '::',
												...
												},
												{
													...
													_0: _elm_lang$html$Html$text(
														_abradley2$elm_datepicker$DatePicker_Util$getDayMonthText(_p4)),
													_1: {ctor: '[]'}
												})
										},
										_1: {ctor: '[]'}
		...
		return A2(
			_elm_lang$html$Html$div,
			{
				...
				_0: _elm_lang$html$Html_Attributes$classList(
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'edp-year-picker', _1: true},
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
			...
			},
			{
				ctor: '::',
				_0: function () {
					var selectedYear = _elm_lang$core$Date$year(
						A2(_elm_lang$core$Maybe$withDefault, model.today, model.selectedDate));
					var offset = _elm_lang$core$Basics$toString(
						(((_elm_lang$core$List$length(model.yearList) * 40) / 2) | 0) - 40);
					var listHeight = _elm_lang$core$Basics$toString(
						_elm_lang$core$List$length(model.yearList) * 40);
					return A2(
						_elm_lang$html$Html$div,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$classList(
								{
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'edp-year-picker-body', _1: true},
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$style(
									{
										...
										_0: {
											ctor: '_Tuple2',
											_0: 'height',
											_1: A2(_elm_lang$core$Basics_ops['++'], listHeight, 'px')
										},
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
										...
										_0: A2(
											_elm_lang$html$Html$button,
											{
												...
												_0: _elm_lang$html$Html_Attributes$classList(
													{
														ctor: '::',
														_0: {ctor: '_Tuple2', _0: 'edp-button', _1: true},
														_1: {
															ctor: '::',
															_0: {ctor: '_Tuple2', _0: 'edp-year-button', _1: true},
															_1: {
																ctor: '::',
																_0: {
																	ctor: '_Tuple2',
																	_0: 'edp-year-button-selected',
																	_1: _elm_lang$core$Native_Utils.eq(year, selectedYear)
																},
																_1: {ctor: '[]'}
															}
														}
...
var _abradley2$elm_datepicker$DatePicker$init = function (id) {
	return {
		ctor: '_Tuple2',
		_0: {
			id: id,
...
var _abradley2$elm_datepicker$DatePicker$update = F2(
	function (msg, model) {
		var _p5 = msg;
		switch (_p5.ctor) {
			case 'NoOp':
			...
			case 'DateSelected':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							selectedDate: _elm_lang$core$Maybe$Just(_p5._0),
							previousSelectedDate: _elm_lang$core$Maybe$Just(_p5._1)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'NextMonth':
				var newModel = A2(_abradley2$elm_datepicker$DatePicker$setIndexDate, model, _p5._0);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						newModel,
			...
			case 'SetYear':
				var newModel = A2(
					...
					A7(
						_rluiten$elm_date_extra$Date_Extra_Create$dateFromFields,
						_p5._1,
						_elm_lang$core$Date$month(_p5._0),
						1,
						0,
						0,
						0,
			...
			case 'GetToday':
				var _p6 = _p5._0;
				var updatedModel = A2(_abradley2$elm_datepicker$DatePicker$setIndexDate, model, _p6);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						updatedModel,
			...
			case 'SetSelectionMode':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{selectionMode: _p8, previousMonthMap: _elm_lang$core$Maybe$Nothing}),
					_1: function () {
						var _p7 = _p8;
						if (_p7.ctor === 'Calendar') {
				...
				_1: {
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: _elm_lang$html$Html$text(
								function () {
									var _p9 = _abradley2$elm_datepicker$DatePicker_Util$getMonthInfo(
										_elm_lang$core$Date$month(model.indexDate));
									var monthFull = _p9._0;
									var monthInt = _p9._1;
									return A2(
										_elm_lang$core$Basics_ops['++'],
										monthFull,
		...
		return A2(
			...
			A2(
				...
				function (_p10) {
					...
					var _p16 = _p11._0;
					var _p15 = _p11._1;
					var canSelect = props.canSelectDate(_p15);
					var isToday = _elm_lang$core$Native_Utils.eq(
						_elm_lang$core$Date$toTime(model.today),
						_elm_lang$core$Date$toTime(_p15));
					var isSelected = function () {
						var _p12 = model.selectedDate;
						if (_p12.ctor === 'Just') {
							return _elm_lang$core$Native_Utils.eq(
								_elm_lang$core$Date$toTime(_p12._0),
								_elm_lang$core$Date$toTime(_p15));
						} else {
							return false;
						}
					...
					return A2(
						_elm_lang$html$Html$div,
						{
							...
							_0: _elm_lang$html$Html_Attributes$classList(
								{
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'edp-column edp-day-number', _1: true},
									_1: {
										ctor: '::',
										_0: {
											ctor: '_Tuple2',
											_0: 'edp-empty-column',
											_1: _elm_lang$core$Native_Utils.eq(_p16, 0)
										},
										_1: {
											ctor: '::',
											_0: {
												ctor: '_Tuple2',
												_0: 'edp-disabled-column',
												_1: _elm_lang$core$Native_Utils.eq(canSelect, false)
											},
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'edp-day-number-selected', _1: isSelected},
												_1: {
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'edp-day-number-today', _1: isToday},
													_1: {ctor: '[]'}
												}
											}
										}
							...
							_1: {
								...
								_0: _elm_lang$html$Html_Events$onClick(
									function () {
										var _p13 = model.selectedDate;
										if (_p13.ctor === 'Just') {
											var _p14 = _p13._0;
											return _elm_lang$core$Native_Utils.eq(
												_elm_lang$core$Date$toTime(_p14),
												_elm_lang$core$Date$toTime(_p15)) ? _abradley2$elm_datepicker$DatePicker$NoOp : A2(_abradley2$elm_datepicker$DatePicker$DateSelected, _p15, _p14);
										} else {
											return A2(_abradley2$elm_datepicker$DatePicker$DateSelected, _p15, model.today);
										}
									}()),
								_1: {ctor: '[]'}
							}
...
var _abradley2$elm_datepicker$DatePicker$bottomSection = F2(
	function (model, props) {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('edp-body-section edp-bottom-section'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
...
var _abradley2$elm_datepicker$DatePicker$view = F2(
	function (model, props) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('edp-container'),
					_1: {ctor: '[]'}
				},
				{ctor: '[]'}),
			A4(
...
var _abradley2$elm_datepicker$Demo$DatePickerMsg = function (a) {
	return {ctor: 'DatePickerMsg', _0: a};
};
var _abradley2$elm_datepicker$Demo$init = function () {
	var _p0 = _abradley2$elm_datepicker$DatePicker$init('my-datepicker');
	...
	return {
		...
		_1: A2(_elm_lang$core$Platform_Cmd$map, _abradley2$elm_datepicker$Demo$DatePickerMsg, datePickerCmd)
	};
}();
			...
			return function (_p2) {
				...
				if (_p4.ctor === 'SubmitClicked') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							_p6,
							{
								selectedDate: _elm_lang$core$Maybe$Just(_p4._0)
							}),
						_1: _p5
					};
				} else {
				...
				function (_p7) {
					...
					return {
						...
						_1: A2(_elm_lang$core$Platform_Cmd$map, _abradley2$elm_datepicker$Demo$DatePickerMsg, _p8._1)
					};
				}(
					A2(_abradley2$elm_datepicker$DatePicker$update, _p9, model.datePickerData)));
		}
	});
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						_abradley2$elm_datepicker$Demo$DatePickerMsg,
						A2(_abradley2$elm_datepicker$DatePicker$view, model.datePickerData, _abradley2$elm_datepicker$DatePicker$defaultProps)),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
...
if (typeof _abradley2$elm_datepicker$Demo$main !== 'undefined') {
    _abradley2$elm_datepicker$Demo$main(Elm['Demo'], 'Demo', {"types":{"unions":{"DatePicker.Msg":{"args":[],"tags":{"NextMonth":["Date.Date"],"SubmitClicked":["Date.Date"],"DateSelected":["Date.Date","Date.Date"],"SetYear":["Date.Date","Int"],"NoOp":[],"SetSelectionMode":["DatePicker.SelectionMode"],"PreviousMonth":["Date.Date"],"CancelClicked":[],"GetToday":["Date.Date"]}},"Date.Date":{"args":[],"tags":{"Date":[]}},"Demo.Msg":{"args":[],"tags":{"DatePickerMsg":["DatePicker.Msg"],"NoOp":[]}},"DatePicker.SelectionMode":{"args":[],"tags":{"Calendar":[],"YearPicker":[]}}},"aliases":{},"message":"Demo.Msg"},"versions":{"elm":"0.18.0"}});
}
