									...
									_elm_lang$html$Html$div,
									{
										...
										_0: _elm_lang$html$Html_Attributes$class(
											A2(
												_elm_lang$core$Basics_ops['++'],
												'edp-month-slider ',
												_elm_lang$core$Native_Utils.eq(model.monthChange, _user$project$DatePicker$Next) ? 'edp-in-next' : 'edp-in-previous')),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
							...
							_1: {
								...
								_1: {
									...
									_0: _elm_lang$html$Html_Attributes$style(
										{
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'color', _1: okButtonColor},
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
...
if (typeof _user$project$Demo$main !== 'undefined') {
    _user$project$Demo$main(Elm['Demo'], 'Demo', undefined);
}
